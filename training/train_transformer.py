...
def full_train_fn(rank):
    ...
    try:
        ...
        class SimpleQADataset(torch.utils.data.Dataset):
            ...
            def __getitem__(self, idx):
                ...
                return {
                    ...
                    'start_positions': torch.tensor(0, dtype=torch.long),  # Dummy
                    'end_positions': torch.tensor(1, dtype=torch.long)     # Dummy
                }
        ...
        if xm.is_master_ordinal():
            ...
            checkpoint_path = os.path.join(checkpoint_dir, 'qa_transformer_checkpoint.pt')
